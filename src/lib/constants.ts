  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        value: 'go',
        label: 'Go (Golang)',
        recommendations: ['Build microservices in Go', 'Learn goroutines and channels', 'Master the Go standard library', 'Build CLI tools', 'Understand Go interfaces'],
        scoreWeight: 0.83,
        mentorExplanation:
          "Go is designed for simplicity and efficiency - perfect for backend services and cloud infrastructure! Its concurrency model with goroutines is incredibly elegant. Start with 'A Tour of Go' (free, interactive). Go forces you to handle errors explicitly, which makes code more robust. The standard library is extensive - you can build a lot without dependencies. Go compiles to a single binary, making deployment dead simple. The language is intentionally small - you can learn most of it in a weekend, but mastering it takes practice. Great for microservices, APIs, and DevOps tools.",
        resources: [
          { title: 'A Tour of Go', url: 'https://go.dev/tour/', type: 'docs', description: 'Interactive introduction to Go. Best place to start!' },
          { title: 'Go by Example', url: 'https://gobyexample.com/', type: 'docs', description: 'Hands-on introduction with annotated example programs.' },
          { title: 'Effective Go', url: 'https://go.dev/doc/effective_go', type: 'docs', description: 'Official guide to writing clear, idiomatic Go code.' },
          { title: 'Learn Go with Tests', url: 'https://quii.gitbook.io/learn-go-with-tests/', type: 'book', description: 'TDD approach to learning Go. Free and practical.' },
        ],
      },
      {
        value: 'csharp',
        label: 'C# / .NET',
        recommendations: ['Build ASP.NET Core applications', 'Master LINQ and async patterns', 'Learn Entity Framework', 'Understand dependency injection', 'Explore Blazor'],
        scoreWeight: 0.82,
        mentorExplanation:
          "C# and .NET have evolved dramatically - it's now cross-platform, fast, and modern! .NET Core changed everything. LINQ is incredibly powerful for data manipulation. Learn async/await deeply - C# has one of the best async implementations. ASP.NET Core is solid for web APIs. Entity Framework makes database work smooth. The ecosystem is mature with excellent tooling (Visual Studio, Rider). Blazor brings C# to the frontend if you're interested. Great for enterprise applications, games (Unity), and desktop apps. Microsoft's investment in .NET is huge!",
        resources: [
          { title: 'C# Programming Guide', url: 'https://learn.microsoft.com/en-us/dotnet/csharp/', type: 'docs', description: 'Official Microsoft documentation.' },
          { title: '.NET Tutorial', url: 'https://dotnet.microsoft.com/learn', type: 'course', description: 'Official learning path for .NET.' },
          { title: 'ASP.NET Core Fundamentals', url: 'https://learn.microsoft.com/en-us/aspnet/core/', type: 'docs', description: 'Modern web development with .NET.' },
        ],
      },
      {
        value: 'redis',
        label: 'Redis / Caching',
        recommendations: ['Implement caching strategies', 'Learn Redis data structures', 'Master cache invalidation patterns', 'Use Redis for pub/sub', 'Optimize application performance'],
        scoreWeight: 0.77,
        mentorExplanation:
          "Redis is much more than a cache - it's an in-memory data structure store! Understanding caching is crucial for performance. Learn the different eviction policies, when to cache (and when not to), and cache invalidation strategies (the hardest problem in computer science, they say!). Redis has powerful data structures: sorted sets, hashes, streams. Use it for caching, session storage, real-time analytics, pub/sub messaging, and rate limiting. Master Redis and you'll dramatically improve application performance.",
        resources: [
          { title: 'Redis University', url: 'https://university.redis.com/', type: 'course', description: 'Free official courses on Redis.' },
          { title: 'Redis Documentation', url: 'https://redis.io/docs/', type: 'docs', description: 'Comprehensive official docs.' },
          { title: 'Caching Best Practices', url: 'https://aws.amazon.com/caching/best-practices/', type: 'article', description: 'When and how to cache effectively.' },
        ],
      },
      {
        value: 'swift',
        label: 'Swift / iOS Development',
        recommendations: ['Build native iOS apps', 'Learn SwiftUI', 'Master UIKit fundamentals', 'Understand iOS design patterns', 'Learn Combine framework'],
        scoreWeight: 0.8,
        mentorExplanation:
          "Swift is Apple's modern language for iOS/macOS development - clean syntax and powerful features! SwiftUI is the future of Apple UI development - declarative and reactive. But learn UIKit too; it's still widely used. iOS development has its quirks: the Apple ecosystem, App Store review process, provisioning profiles. Swift optionals force you to handle null safety. The iOS market is lucrative - users spend more on apps. Great for mobile developers wanting to target iOS specifically.",
        resources: [
          { title: '100 Days of SwiftUI', url: 'https://www.hackingwithswift.com/100/swiftui', type: 'course', description: 'Free comprehensive SwiftUI course by Paul Hudson.' },
          { title: 'Swift Programming Language', url: 'https://docs.swift.org/swift-book/', type: 'docs', description: 'Official Swift book from Apple.' },
          { title: 'iOS App Dev Tutorials', url: 'https://developer.apple.com/tutorials/app-dev-training', type: 'docs', description: 'Official Apple tutorials.' },
        ],
      },
      {
        value: 'kotlin',
        label: 'Kotlin / Android Development',
        recommendations: ['Build Android apps', 'Learn Jetpack Compose', 'Master coroutines', 'Understand Android architecture', 'Learn Kotlin multiplatform'],
        scoreWeight: 0.8,
        mentorExplanation:
          "Kotlin is now Google's preferred language for Android - it's Java but better! More concise, null-safe by default, and has modern features. Jetpack Compose is transforming Android UI development (similar to React/SwiftUI). Coroutines make async code clean. Android has massive market share globally. Kotlin Multiplatform is interesting - share code between platforms. The Android ecosystem is vibrant and open. Great career path with huge demand!",
        resources: [
          { title: 'Android Basics with Compose', url: 'https://developer.android.com/courses/android-basics-compose/course', type: 'course', description: 'Official modern Android course.' },
          { title: 'Kotlin Documentation', url: 'https://kotlinlang.org/docs/home.html', type: 'docs', description: 'Official Kotlin docs.' },
          { title: 'Kotlin Koans', url: 'https://play.kotlinlang.org/koans/', type: 'docs', description: 'Interactive Kotlin exercises.' },
        ],
      },
      {
        value: 'php',
        label: 'PHP / Laravel',
        recommendations: ['Learn modern PHP features', 'Master Laravel framework', 'Build RESTful APIs', 'Understand Composer', 'Learn Laravel Eloquent ORM'],
        scoreWeight: 0.75,
        mentorExplanation:
          "Modern PHP (8+) is completely different from old PHP - it's fast, typed, and has a great ecosystem! Laravel is one of the most elegant frameworks out there. The community is strong, documentation is excellent. Learn modern PHP features: typed properties, attributes, fibers. Laravel's ecosystem is rich: Livewire, Inertia, Vapor. PHP powers a huge portion of the web (WordPress, etc.). Don't dismiss it because of old stereotypes - modern PHP is productive and powerful!",
        resources: [
          { title: 'Laravel Bootcamp', url: 'https://bootcamp.laravel.com/', type: 'course', description: 'Official Laravel learning path.' },
          { title: 'PHP: The Right Way', url: 'https://phptherightway.com/', type: 'docs', description: 'Best practices for modern PHP.' },
          { title: 'Laracasts', url: 'https://laracasts.com/', type: 'course', description: 'Premium video tutorials for Laravel and PHP.' },
        ],
      },
      {
        value: 'ruby',
        label: 'Ruby / Ruby on Rails',
        recommendations: ['Build Rails applications', 'Learn Ruby idioms', 'Master ActiveRecord', 'Understand convention over configuration', 'Build RESTful services'],
        scoreWeight: 0.75,
        mentorExplanation:
          "Ruby prioritizes developer happiness - the code reads like English! Rails popularized convention over configuration and remains incredibly productive. The 'Rails way' is opinionated, which means faster development. Ruby's meta-programming is powerful but use it wisely. The community values testing, good documentation, and clean code. Rails is mature and battle-tested. Great for startups and MVPs - you can build fast! Though not as trendy as it once was, Rails is still powering many successful companies.",
        resources: [
          { title: 'Ruby on Rails Guides', url: 'https://guides.rubyonrails.org/', type: 'docs', description: 'Official comprehensive Rails guides.' },
          { title: 'The Odin Project Ruby Path', url: 'https://www.theodinproject.com/paths/full-stack-ruby-on-rails', type: 'course', description: 'Free full-stack Ruby course.' },
          { title: 'Eloquent Ruby', url: 'https://www.amazon.com/Eloquent-Ruby-Addison-Wesley-Professional/dp/0321584104', type: 'book', description: 'Write Ruby like a Rubyist.' },
        ],
      },
      {
        value: 'elixir',
        label: 'Elixir / Phoenix',
        recommendations: ['Learn functional programming concepts', 'Build Phoenix applications', 'Master OTP patterns', 'Understand concurrency model', 'Build real-time features with LiveView'],
        scoreWeight: 0.85,
        mentorExplanation:
          "Elixir brings functional programming to the powerful Erlang VM - built for concurrency and fault tolerance! Phoenix is incredibly fast and Phoenix LiveView is game-changing (real-time features without writing JavaScript). The 'Let it crash' philosophy is mind-bending at first. Pattern matching is elegant. Great for real-time systems, chat apps, and high-concurrency scenarios. The community is welcoming and thoughtful. Learning Elixir teaches you functional programming principles that apply everywhere!",
        resources: [
          { title: 'Elixir School', url: 'https://elixirschool.com/', type: 'docs', description: 'Free comprehensive Elixir lessons.' },
          { title: 'Phoenix Framework Guides', url: 'https://hexdocs.pm/phoenix/overview.html', type: 'docs', description: 'Official Phoenix documentation.' },
          { title: 'Programming Elixir', url: 'https://pragprog.com/titles/elixir16/programming-elixir-1-6/', type: 'book', description: 'Excellent book by Dave Thomas.' },
        ],
      },
      {
        value: 'terraform',
        label: 'Terraform / Infrastructure as Code',
        recommendations: ['Master IaC concepts', 'Learn Terraform state management', 'Build reusable modules', 'Understand cloud provisioning', 'Implement GitOps workflows'],
        scoreWeight: 0.84,
        mentorExplanation:
        ...
        resources: [
          { title: 'Terraform Tutorials', url: 'https://developer.hashicorp.com/terraform/tutorials', type: 'docs', description: 'Official HashiCorp learning path.' },
          { title: 'Terraform Best Practices', url: 'https://www.terraform-best-practices.com/', type: 'docs', description: 'Community best practices guide.' },
          { title: 'Terraform Up & Running', url: 'https://www.terraformupandrunning.com/', type: 'book', description: 'Comprehensive book by Yevgeniy Brikman.' },
        ],
      },
      {
        value: 'jenkins',
        label: 'Jenkins / CI/CD',
        recommendations: ['Build CI/CD pipelines', 'Master pipeline as code', 'Learn deployment automation', 'Implement testing automation', 'Understand GitOps principles'],
        scoreWeight: 0.78,
        mentorExplanation:
        ...
        resources: [
          { title: 'Jenkins Documentation', url: 'https://www.jenkins.io/doc/', type: 'docs', description: 'Official Jenkins docs.' },
          { title: 'CI/CD Best Practices', url: 'https://www.atlassian.com/continuous-delivery', type: 'article', description: 'Comprehensive CI/CD guide.' },
          { title: 'GitHub Actions Tutorial', url: 'https://docs.github.com/en/actions', type: 'docs', description: 'Modern CI/CD alternative.' },
        ],
      },
      {
        value: 'tailwind',
        label: 'Tailwind CSS / Utility-First CSS',
        recommendations: ['Master utility-first approach', 'Learn responsive design patterns', 'Build custom design systems', 'Optimize for production', 'Learn JIT mode'],
        scoreWeight: 0.76,
        mentorExplanation:
          "Tailwind CSS changed how we write CSS - utility-first is incredibly productive once you embrace it! At first, the long class names feel wrong, but you'll never want to name things again. You build faster, maintain easier, and the consistency is automatic. Learn the design system (spacing, colors), responsive utilities, and how to extract components when needed. JIT mode gives you arbitrary values. Tailwind is taking over - especially in React/Next.js ecosystems. The constraint of utilities actually increases creativity!",
        resources: [
          { title: 'Tailwind CSS Docs', url: 'https://tailwindcss.com/docs', type: 'docs', description: 'Excellent searchable documentation.' },
          { title: 'Tailwind UI', url: 'https://tailwindui.com/', type: 'docs', description: 'Premium components (worth studying even if not buying).' },
          { title: 'Build Anything with Tailwind', url: 'https://www.youtube.com/c/TailwindLabs', type: 'video', description: 'Official YouTube channel with tips.' },
        ],
      },
      {
        value: 'flutter',
        label: 'Flutter / Dart',
        recommendations: ['Build cross-platform apps', 'Master widget composition', 'Learn state management (Bloc, Riverpod)', 'Understand Flutter architecture', 'Build for iOS and Android'],
        scoreWeight: 0.81,
        mentorExplanation:
          "Flutter lets you build beautiful native apps for mobile, web, and desktop from a single codebase! The widget system is elegant - everything's a widget. Dart is easy to learn if you know JavaScript or Java. Flutter's hot reload is incredibly productive. Learn state management early (Riverpod is popular). Performance is generally excellent. The community is growing fast. Great choice for cross-platform development - you can reach every platform with one codebase. Google's backing gives it staying power.",
        resources: [
          { title: 'Flutter Documentation', url: 'https://docs.flutter.dev/', type: 'docs', description: 'Comprehensive official docs with codelabs.' },
          { title: 'Flutter Widget Catalog', url: 'https://docs.flutter.dev/development/ui/widgets', type: 'docs', description: 'Complete widget reference.' },
          { title: 'Flutter Course by Angela Yu', url: 'https://www.udemy.com/course/flutter-bootcamp-with-dart/', type: 'course', description: 'Popular comprehensive Flutter course.' },
        ],
      },
      {
        value: 'svelte',
        label: 'Svelte / SvelteKit',
        recommendations: ['Learn reactive programming in Svelte', 'Build SvelteKit apps', 'Master stores and context', 'Understand compilation approach', 'Build performant UIs'],
        scoreWeight: 0.79,
        mentorExplanation:
          "Svelte is refreshingly different - it's a compiler, not a runtime framework! This means smaller bundle sizes and great performance. The reactive syntax is intuitive - just assignments trigger updates. SvelteKit is the full-stack framework. Svelte is gaining traction fast - developers love it for its simplicity and performance. Less boilerplate than React, more intuitive than Vue. Great for projects where bundle size matters or you want a fresh approach. The community is enthusiastic and growing!",
        resources: [
          { title: 'Svelte Tutorial', url: 'https://svelte.dev/tutorial', type: 'docs', description: 'Interactive official tutorial. Best way to start!' },
          { title: 'SvelteKit Docs', url: 'https://kit.svelte.dev/docs/introduction', type: 'docs', description: 'Full-stack Svelte framework.' },
          { title: 'Svelte Society', url: 'https://sveltesociety.dev/', type: 'docs', description: 'Community recipes and resources.' },
        ],
      },
      {
        value: 'solidity',
        label: 'Solidity / Web3',
        recommendations: ['Learn blockchain fundamentals', 'Build smart contracts', 'Master contract security', 'Understand gas optimization', 'Learn Web3.js or Ethers.js'],
        scoreWeight: 0.82,
        mentorExplanation:
          "Web3 and blockchain are creating new paradigms! Solidity is for writing Ethereum smart contracts. Security is CRITICAL - bugs in smart contracts can cost millions. Understand gas optimization, common vulnerabilities (reentrancy, etc.), and testing thoroughly. The field is evolving rapidly. Start with blockchain fundamentals before diving into Solidity. Whether Web3 is the future or hype is debated, but the underlying concepts (decentralization, cryptography) are valuable to understand.",
        resources: [
          { title: 'CryptoZombies', url: 'https://cryptozombies.io/', type: 'course', description: 'Learn Solidity through building a game. Fun and interactive!' },
          { title: 'Solidity Documentation', url: 'https://docs.soliditylang.org/', type: 'docs', description: 'Official Solidity docs.' },
          { title: 'Smart Contract Security', url: 'https://github.com/ethereumbook/ethereumbook', type: 'book', description: 'Free book on Ethereum development.' },
        ],
      },
      {
        value: 'fastapi',
        label: 'FastAPI / Modern Python Web',
        recommendations: ['Build async Python APIs', 'Master Pydantic models', 'Learn auto-generated docs', 'Understand async/await in Python', 'Implement authentication'],
        scoreWeight: 0.8,
        mentorExplanation:
          "FastAPI is the modern way to build Python APIs - fast, intuitive, and production-ready! It uses type hints for validation and auto-generates beautiful API docs. Async support makes it performant. Pydantic models provide data validation. Coming from Flask or Django? FastAPI feels fresh and modern. The developer experience is excellent - auto-complete everywhere! Great for microservices, ML model APIs, or any backend API. It's gaining adoption rapidly!",
        resources: [
          { title: 'FastAPI Documentation', url: 'https://fastapi.tiangolo.com/', type: 'docs', description: 'Excellent docs with tutorials.' },
          { title: 'FastAPI Best Practices', url: 'https://github.com/zhanymkanov/fastapi-best-practices', type: 'github', description: 'Community best practices.' },
          { title: 'Full Stack FastAPI', url: 'https://github.com/tiangolo/full-stack-fastapi-postgresql', type: 'github', description: 'Full-stack project template.' },
        ],
      },
      {
        value: 'prisma',
        label: 'Prisma / Modern ORMs',
        recommendations: ['Master Prisma schema', 'Learn migrations', 'Optimize database queries', 'Understand type-safe database access', 'Build with Prisma Client'],
        scoreWeight: 0.77,
        mentorExplanation:
          "Prisma brings type-safety to database access - it's changing how we work with databases in TypeScript! The schema is declarative and migration system is smooth. Prisma Client is auto-generated and fully typed. Great developer experience with auto-complete. Works with PostgreSQL, MySQL, SQLite, SQL Server, MongoDB. Compared to traditional ORMs (TypeORM, Sequelize), Prisma feels more modern. The query API is intuitive. Database work becomes safer and more productive!",
        resources: [
          { title: 'Prisma Documentation', url: 'https://www.prisma.io/docs', type: 'docs', description: 'Comprehensive official docs.' },
          { title: 'Prisma Tutorial', url: 'https://www.prisma.io/docs/getting-started', type: 'course', description: 'Get started with Prisma.' },
          { title: 'Prisma Best Practices', url: 'https://www.prisma.io/docs/guides/performance-and-optimization', type: 'docs', description: 'Performance and optimization guide.' },
        ],
      },
      {
        value: 'figma',
        label: 'Figma / Design Tools',
        recommendations: ['Learn UI/UX principles', 'Master component design', 'Understand design systems', 'Learn prototyping', 'Collaborate with designers effectively'],
        scoreWeight: 0.72,
        mentorExplanation:
          "Understanding design makes you a more complete developer! Figma is the industry-standard design tool. Learn to read design specs, understand spacing and typography, use design tokens. Auto-layout is powerful for responsive designs. Good developers who understand design are incredibly valuable. You don't need to be a designer, but understanding design thinking and tools bridges the developer-designer gap. This makes you more effective and collaborative!",
        resources: [
          { title: 'Figma Tutorial', url: 'https://help.figma.com/hc/en-us/categories/360002051613', type: 'docs', description: 'Official Figma learning resources.' },
          { title: 'UI/UX Fundamentals', url: 'https://www.coursera.org/learn/ui-ux-design', type: 'course', description: 'Learn design principles.' },
          { title: 'Refactoring UI', url: 'https://www.refactoringui.com/', type: 'book', description: 'Design for developers. Excellent resource!' },
        ],
      },
    ],
  },
    ...
    options: [
      ...
      },
      {
        ...
        resources: [
          ...
          { title: 'Time-Boxing Debugging', url: 'https://www.freecodecamp.org/news/how-to-debug-code/', type: 'article' },
        ],
      },
      {
        value: 'use-logging',
    ...
    options: [
      ...
      },
      {
        ...
        resources: [
          ...
          { title: 'Having Difficult Conversations', url: 'https://hbr.org/2017/05/how-to-have-difficult-conversations-when-you-dont-like-conflict', type: 'article' },
        ],
      },
    ],
  },
    ...
    options: [
      ...
      },
      {
        ...
        resources: [
          ...
          { title: 'Microservices Patterns', url: 'https://microservices.io/patterns/index.html', type: 'docs' },
          { title: 'Building Microservices', url: 'https://www.oreilly.com/library/view/building-microservices-2nd/9781492034018/', type: 'book' },
        ],
      },
      {
        value: 'over-engineer',
        ...
        resources: [
          ...
          { title: 'The Art of Simple Design', url: 'https://www.amazon.com/Understanding-Four-Rules-Design-Beck/dp/1491997182', type: 'book' },
        ],
      },
    ],
  },
